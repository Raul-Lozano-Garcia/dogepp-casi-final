        ...
        <section id="bienvenida_usuario" class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p>Esperemos que tu estancia aquí sea lo más agradable posible. Usando Dogepp podrás conocer gente nueva, hacer planes juntos, compartir momentos increibles...¡y todo junto a tu fiel compañero perruno!</p>

                    <?php
                        if($_SESSION["tipo"]==='a'){
                    ?>
                        <div class='text-center'><a class='btn boton_complementario' href='usuarios1_5.php'>Siguiente</a></div>
                    <?php
                        }else{
                    ?>
