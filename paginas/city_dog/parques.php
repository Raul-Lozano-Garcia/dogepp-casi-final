...
<body>
    ...
    <main id="swup" class="transition-fade container">
        ...
        <section id="chats">
            ...
            <?php
                //SACO LOS PARQUES
                $consulta_parque="SELECT id,imagen,nombre,descripcion FROM parque WHERE activo='1'";
                ...
                if($filas_devueltas===0){
                    echo "<div class='aun_no text-center'><h1>Aún no hay parques. Para crear tú uno clica en el botón + de abajo.</h1></div>";
                }else{
                                ...
                                <div class='row'>
                                    <div class='col-12 fila_chats'>
                                        <div class='img-chat me-4'>
                                            <img src='../../assets/imagenes/city_dog/parques/$fila_mensaje[imagen]' alt='foto' class='img-fluid'>
                                        </div>
                                        <div class='contenido'>
                                            <h2>$fila_mensaje[nombre]</h2>
                                            <div>
                                                <h3 class='h6'>$fila_mensaje[descripcion]</h3>
                                            </div> 
                                                  
                                        </div>
                                        <form action='perfil_parque.php' method='GET' class='m-3'>
       ...
       <div class="row container-fluid">
            <div class="col-12"> 
                <a href="agregar_parques.php"><div class="boton-mas text-center">+</div></a>
            </div>
        </div>
