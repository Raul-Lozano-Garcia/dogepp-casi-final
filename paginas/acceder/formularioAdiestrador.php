...
<body>
    ...
    <main id="swup" class="transition-fade">
        ...
        <!-- FORMULARIO CREAR ADIESTRADOR -->
        <section id="formu_crear_adiestrador" class="container-fluid formuGeneral">
            <div class="row">
                <div class="col-12">
                    <div class="container">
                        <div class="row fila_formu">
                            <div class="form-body mx-auto p-3">
                                ...
                                <h1>Dogepp</h1>
                                <h2>Formulario de usuarios adiestradores</h2>
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['enviar'])){
                                        ...
                                        if(trim($_POST['dni'])==="" || trim($_POST['nombre'])==="" || trim($_POST['pass'])==="" || trim($_POST['pass'])===""){
                                            echo "<meta http-equiv='refresh' content='0; url=formularioAdiestrador.php'>";
                                        ...
                                        //SI ALGÚN CAMPO NO CUMPLE CON LOS REQUISITOS LO REDIRIJO A LA PROPIA PAGINA
                                            ...
                                            if($filas_devueltas>0){
                                                ...
                                                $consulta_insercion="INSERT INTO usuario values (?,'a',?,'default.png',?,?,null,'1','Hola. Estoy usando Dogepp :)')";
                                                ...
                                                echo "<meta http-equiv='refresh' content='0; url=formularioAdiestrador.php?ok'>";
                                            }
                                        }
                                    }
                                ?>
        ...
        <!-- FIN FORMULARIO CREAR ADIESTRADOR -->
