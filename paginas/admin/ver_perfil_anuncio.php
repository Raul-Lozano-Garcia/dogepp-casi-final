...
<body>
    ...
    if(isset($_POST["id"])){
        ...
        $consulta_info="SELECT anuncio.imagen imagen,titulo,precio,descripcion,nick FROM anuncio INNER JOIN usuario ON dni=id_usuario WHERE id='$id'";
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="foto_perfil">
                            <div><img src="../../assets/imagenes/adiestradores/anuncios/<?php echo $fila_info['imagen'] ?>" alt="imagen perfil" class="img-fluid"></div>
                        </div>
                        <div class="info_perfil">
                            <h1><?php echo "$fila_info[titulo]" ?></h1>
                            <h3>Autor: <?php echo "$fila_info[nick]" ?></h3>
                            <h3>Precio: <?php echo "$fila_info[precio]€" ?></h3>
                            <div>
